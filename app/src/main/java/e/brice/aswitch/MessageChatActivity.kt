...
import e.brice.aswitch.AdapterClasses.ChatsAdapter
import e.brice.aswitch.Fragments.APIService
import e.brice.aswitch.ModelClasses.Chat
import e.brice.aswitch.ModelClasses.Users
import e.brice.aswitch.Notification.*
...
class MessageChatActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        toolbar.setNavigationOnClickListener {
            ...
            finish() // you can delete that if ur App crash after -> click on this tab
        }
