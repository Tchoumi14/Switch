package e.brice.aswitch.AdapterClasses
...
import e.brice.aswitch.MainActivity
import e.brice.aswitch.MessageChatActivity
import e.brice.aswitch.ModelClasses.Chat
import e.brice.aswitch.ModelClasses.Users
import e.brice.aswitch.R
import e.brice.aswitch.VisitUserProfileActivity
    ...
    ) : RecyclerView.Adapter<UserAdapter.ViewHolder?>()
{
    ...
    override fun onBindViewHolder(holder: ViewHolder, i: Int)
    {
        ...
        Picasso.get().load(user.getProfile()).placeholder(R.drawable.profi).into(holder.profileImageView)
